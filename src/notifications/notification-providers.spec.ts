...
const MESSAGE: RenderedTemplate = {
  ...
  body: 'Hallo <Kunde>,\n\nbitte bestätige: https://carsalepro.com/verify?t=abc',
...
describe('EmailProviderImpl (Resend)', () => {
  ...
  it('sends through Resend with both text and escaped html when a key is configured', async () => {
    ...
    const provider = makeProvider({ key: 're_live_key', replyTo: 'support@carsalepro.com' });
    ...
    expect(html).toContain('href="https://carsalepro.com/verify?t=abc"');
  });
