...
| Testing | Jest unit + Supertest e2e (**460 e2e across 25 suites**, 428 unit) |
...
```bash
npm test                                               # unit tests
npm run test:e2e -- --forceExit                        # 460 e2e / 25 suites (needs Postgres+PostGIS on :5433)
